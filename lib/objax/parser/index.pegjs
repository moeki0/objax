...
EventAction
  = "on" name:Name _ guard:Guard? _ "is" _ transition:FieldValue {
    return {
      type: "EventAction",
...
Guard
  = "when" _ value:Value { return value }
...
NameLiteral
  = name:Name { return { type: "NameLiteral", value: name.name } }
