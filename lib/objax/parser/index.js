...
function peg$parse(input, options) {
  ...
  const peg$e42 = peg$otherExpectation("integer");
  ...
  function peg$f34(name) {    return { type: "NameLiteral", value: name.name }  }
  function peg$f35(expr) {    return { type: "Block", expr }  }
  function peg$f36(sign, digits, frac) {
    const raw = digits.join("") + "." + frac.join("");
    const value = parseFloat(raw) * (sign === "-" ? -1 : 1);
    return { type: "Number", value }
  }
  function peg$f37(sign, digits) {
