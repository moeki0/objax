...
function peg$parse(input, options) {
  ...
  const peg$e30 = peg$classExpectation(["+", "-", "_"], false, false, false);
  const peg$e31 = peg$classExpectation(["*", "/"], false, false, false);
  const peg$e32 = peg$literalExpectation("it", false);
  const peg$e33 = peg$literalExpectation("{", false);
  const peg$e34 = peg$literalExpectation("}", false);
  const peg$e35 = peg$otherExpectation("integer");
  ...
  const peg$e41 = peg$literalExpectation("\r", false);
  const peg$e42 = peg$literalExpectation("\n", false);
  const peg$e43 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false, true);
  ...
  function peg$f29() {    return { type: "It" }  }
  function peg$f30(expr) {    return { type: "Block", expr }  }
  function peg$f31(sign, digits) {
