...
function peg$parse(input, options) {
  ...
  const peg$c15 = "name";
  const peg$c16 = "=";
  const peg$c17 = "duplicate";
  const peg$c18 = "on";
  const peg$c19 = "when";
  const peg$c20 = "operation";
  const peg$c21 = ".";
  const peg$c22 = "\"";
  const peg$c23 = "\\\"";
  const peg$c24 = "\\\\";
  ...
  const peg$r0 = /^[\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}A-Za-z_]/u;
  const peg$r1 = /^[\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}A-Za-z0-9_]/u;
  const peg$r2 = /^[^"\\]/;
  const peg$r3 = /^[<>]/;
  const peg$r4 = /^[+\-_]/;
  const peg$r5 = /^[%*\/]/;
  ...
  const peg$e7 = peg$literalExpectation("parent", false);
  const peg$e8 = peg$literalExpectation("is", false);
  const peg$e9 = peg$literalExpectation("transition", false);
  const peg$e10 = peg$literalExpectation("of", false);
  const peg$e11 = peg$literalExpectation("..", false);
  const peg$e12 = peg$literalExpectation("[", false);
  const peg$e13 = peg$literalExpectation("]", false);
  const peg$e14 = peg$literalExpectation(",", false);
  const peg$e15 = peg$literalExpectation("name", false);
  const peg$e16 = peg$literalExpectation("=", false);
  const peg$e17 = peg$literalExpectation("duplicate", false);
  const peg$e18 = peg$literalExpectation("on", false);
  const peg$e19 = peg$literalExpectation("when", false);
  const peg$e20 = peg$literalExpectation("operation", false);
  const peg$e21 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], "_"], false, false, true);
  const peg$e22 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false, true);
  ...
  const peg$e33 = peg$classExpectation(["+", "-", "_"], false, false, false);
  ...
  const peg$e37 = peg$literalExpectation("it", false);
  const peg$e38 = peg$literalExpectation("pi", false);
  const peg$e39 = peg$literalExpectation("e", false);
  ...
  function peg$f2() {    return { type: "ExprStatement", expr: $1 }  }
  function peg$f3(left, tail) {
    let node = left;
    for (const t of tail) node = { type: "Or", left: node, right: t[3] };
    return node;
  }
  function peg$f4(left, tail) {
    let node = left;
  ...
  function peg$f9(name, field, arr) {
  ...
  function peg$f11() {    return { type: "Array", value: [] };  }
  ...
  function peg$f18(name, field, block) {
    return { type: "Operation", name, field, block };
  }
  function peg$f19(name) {
    return { type: "Name", name }
  }
  function peg$f20(ref) {
    return ref;
  }
  function peg$f21(head, tail, rest) {
  ...
  function peg$f29(head, op, right) {
    return { type: "BinaryOp", op, left: head, right };
  }
  function peg$f30(expr) {    return expr;  }
  function peg$f31() {    return { type: "It" }  }
  function peg$f32(name, args) {
    return { type: "FunctionCall", name, args: args ?? [] };
  }
  function peg$f33(head, tail) {    return [head].concat(tail.map(t => t[3]));  }
  function peg$f34(value) {    return { type: "Constant", value }  }
  function peg$f35(name) {    return { type: "NameLiteral", value: name.name }  }
  function peg$f36(expr) {    return { type: "Block", expr }  }
  ...
  function peg$parseName() {
    ...
    s1 = peg$currPos;
    s2 = peg$currPos;
    s3 = peg$parseNameStart();
    if (s3 !== peg$FAILED) {
      s4 = [];
      s5 = peg$parseNameChar();
      while (s5 !== peg$FAILED) {
        s4.push(s5);
        s5 = peg$parseNameChar();
      }
  ...
  function peg$parseEscapedBackslash() {
    let s0, s1;
