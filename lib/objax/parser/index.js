...
function peg$parse(input, options) {
  ...
  const peg$e19 = peg$literalExpectation("operation", false);
  const peg$e20 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], "_"], false, false, true);
  const peg$e21 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false, true);
  ...
  const peg$e32 = peg$classExpectation(["+", "-", "_"], false, false, false);
  ...
  const peg$e36 = peg$literalExpectation("it", false);
  const peg$e37 = peg$literalExpectation("pi", false);
  const peg$e38 = peg$literalExpectation("e", false);
  ...
  function peg$f28(head, op, right) {
    return { type: "BinaryOp", op, left: head, right };
  }
  function peg$f29(expr) {    return expr;  }
  function peg$f30() {    return { type: "It" }  }
  function peg$f31(name, args) {
    return { type: "FunctionCall", name, args: args ?? [] };
  }
  function peg$f32(head, tail) {    return [head].concat(tail.map(t => t[3]));  }
  function peg$f33(value) {    return { type: "Constant", value }  }
  function peg$f34(expr) {    return { type: "Block", expr }  }
  function peg$f35(sign, digits, frac) {
    const raw = digits.join("") + "." + frac.join("");
    const value = parseFloat(raw) * (sign === "-" ? -1 : 1);
    return { type: "Number", value }
  }
  function peg$f36(sign, digits) {
