...
function peg$parse(input, options) {
  ...
  const peg$r5 = /^[0-9]/;
  const peg$r6 = /^[ \t\n\r]/;
  const peg$r7 = /^[\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}A-Za-z0-9_]/u;
  ...
  const peg$e31 = peg$literalExpectation("then", false);
  const peg$e32 = peg$classExpectation([["A", "Z"], ["a", "z"]], false, false, false);
  const peg$e33 = peg$classExpectation(["+", "-", "_"], false, false, false);
  const peg$e34 = peg$classExpectation(["*", "/"], false, false, false);
  const peg$e35 = peg$literalExpectation("it", false);
  const peg$e36 = peg$literalExpectation("{", false);
  const peg$e37 = peg$literalExpectation("}", false);
  const peg$e38 = peg$otherExpectation("integer");
  const peg$e39 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e40 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false, false);
  const peg$e41 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false, true);
  ...
  function peg$f26(expr, thenBranch) {
    return { type: "If", expr, thenBranch }
  }
  function peg$f27(target, additive) {
  ...
  function peg$f30(left, op, right) {    return { type: "BinaryOp", op, left, right };  }
  function peg$f31(expr) {    return expr;  }
  function peg$f32() {    return { type: "It" }  }
  function peg$f33(expr) {    return { type: "Block", expr }  }
  function peg$f34(digits) {
