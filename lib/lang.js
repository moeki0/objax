...
function peg$parse(input, options) {
  ...
  const peg$r6 = /^[ \t\n\r]/;
  const peg$r7 = /^[^\n\r]/;
  const peg$r8 = /^[\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}A-Za-z0-9_]/u;
  ...
  const peg$e43 = peg$literalExpectation("\r", false);
  const peg$e44 = peg$literalExpectation("\n", false);
  const peg$e45 = peg$classExpectation(["\\p{Script=Hiragana}", "\\p{Script=Katakana}", "\\p{Script=Han}", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false, true);
